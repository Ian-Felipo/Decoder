...
QuadTree *load_quadtree_bin(FILE *file, int x, int y, int size) {
...
QuadTree *load_quadtree(const char *filename, int *image_dimension)
{
    ...
    QuadTree *qt = load_quadtree_bin(file, 0, 0, *image_dimension);
